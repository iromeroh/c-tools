...
int main(int argc, char*argv[]){
    ...
    BST * tree = NULL;
    printf("Binary Search Tree data type test\n");
    
    insert(&tree, "Ivan",(void*)"Ruiz",7);
    
    insert(&tree, "Aaron", (void*)"Sanchez", 8);
    
    insert(&tree, "Maria", (void*)"Hernandez",10);
    
    insert(&tree, "Ivan", (void *)"Lopez",5);
    ...
    delete_node(&tree, "Aaron");
    
    in_order(tree, &print_node);
    
    printf("\nDeleting 1 node\n");
    
    delete_node(&tree, "Maria");
    
    in_order(tree, &print_node);
    
    printf("\nDeleting 1 node\n");
    
    delete_node(&tree, "Ivan");
